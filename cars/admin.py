...
#     model = Image
#     fields = ['preview', 'file', 'alt_text', 'uploaded_by']  # Add 'preview'
#     readonly_fields = ['preview', 'uploaded_by']  # Add 'preview'
#     extra = 1
#     can_delete = True
...
#         hhhhhhhhh
#         breakpoint()  # Debugging line to check if save_formset is called
#         instances = formset.save(commit=False)
#         breakpoint()  # Debugging line to check if save_formset is called
#         for instance in instances:
#             if not instance.uploaded_by_id:
#                 breakpoint()  # Debugging line to check if uploaded_by is set
#                 instance.uploaded_by = request.user.uerprofile
#             instance.save()
#         formset.save_m2m()
